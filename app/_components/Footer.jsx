export default function Footer() {
    return (
        ...
        <footer className="flex flex-col bg-orange-200 items-center justify-around w-full py-16 text-sm text-gray-800/70 ">
            ...
            <p className="mt-8 text-center">Copyright © 2025 <a href="https://prebuiltui.com"></a>Ghada Fakhry web developer .</p>
        </footer>
